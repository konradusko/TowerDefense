        ...
        if (this.enemyArray.length != 0) {
           ...
           /*
                if (el.x <= this.breakPoints[0].x + this.oneBox) {
                    ...
                    this.ctx_2.fillRect(el.x, el.y, el.width, el.height);
                } else if (el.y <= this.breakPoints[1].y + this.oneBox && el.x < this.breakPoints[3].x && el.y != this.breakPoints[5].y) {
                    console.log(2);
                    el.y = el.y + this.oneBox / 2;
                    this.ctx_2.fillRect(el.x, el.y, el.width, el.height);
                } else if (el.x <= this.breakPoints[2].x + this.oneBox && el.y < this.breakPoints[4].x+ this.oneBox ) {
                    console.log(3);
                    el.x = el.x + this.oneBox / 2;
                    //    el.y=el.y - this.oneBox/2;
                    this.ctx_2.fillRect(el.x, el.y, el.width, el.height);

                } else if (el.y >= this.breakPoints[3].y - this.oneBox / 2 && el.y < this.breakPoints[4].x+this.oneBox) {
                    console.log(4); 
                    el.y = el.y - this.oneBox / 2 ;
                    this.ctx_2.fillRect(el.x, el.y, el.width, el.height);

                } else if (el.x <= this.breakPoints[4].x ) {
                    console.log(5);
                    el.x = el.x + this.oneBox / 2;
                    this.ctx_2.fillRect(el.x, el.y, el.width, el.height);
                ...
                this.promise = new Promise((res,rej) =>{
                 ...
                 if(el.x <= this.breakPoints[0].x +this.oneBox){
                    ...
                    console.log("pewnie kurwa tez sie robi")
                    el.x=el.x +this.oneBox/2;
                    this.ctx_2.fillRect(el.x,el.y,el.width,el.height);
                }else{
                    res();
                ...
                this.promise.then(() =>{
                   ...
                   if(el.y >=  this.breakPoints[3].y -this.oneBox/2){
                ...
                /*
                        switch(el.x){
                            default:
                                if(el.x <= this.breakPoints[0].x +this.oneBox && el.x <= 5){
                                    el.x = el.x+this.oneBox/2;
                                   // this.ctx_2.fillRect(el.x,el.y,el.width,el.height);
                                }
                            ...
                            break;
                            case 5:
                                console.log("MHHMHMHMHM")
                          
                                console.log("mniejsze?")
                                setTimeout(() => {
                                    while(el.x <= this.breakPoints[0].x+this.oneBox)
                                    {
                                    el.x = el.x+this.oneBox/2;
                                    this.ctx_2.fillRect(el.x,el.y,el.width,el.height);
                                    console.log("while is coming")
                                }
                                }, 1000);
                ...
                */
                /*
                    this.promise.then( () =>{
                        ...
                        this.ctx_2.fillRect(el.x,el.y,el.width,el.height);
                        this.promise = new Promise((resolve,reject) =>{
                            if(el.y<= this.breakPoints[1].y +this.oneBox){
                                resolve();
                            }
                        })
                        this.promise.then(() =>{
                ...
                /*
                    if(el.x <= this.breakPoints[0].x +this.oneBox){
                        ...
                        el.y = el.y+this.oneBox/2;
                        this.ctx_2.fillRect(el.x,el.y,el.width,el.height);
                    }else if(el.x <= this.breakPoints[2].x + this.oneBox && el.x < this.breakPoints[5].y+this.oneBox && el.x != this.breakPoints[4].x&& el.x+40 != this.breakPoints[4].x){
                        console.log(3);
                        el.x = el.x + this.oneBox/2;
                    //    el.y=el.y - this.oneBox/2;
                        this.ctx_2.fillRect(el.x,el.y,el.width,el.height);
                    
                    } else if(el.y >=  this.breakPoints[3].y -this.oneBox/2 && el.x < this.breakPoints[4].x && el.x != this.breakPoints[4].x){
                        console.log(4);
                    ...
                    }else if(el.x <= this.breakPoints[4].x + this.oneBox&& el.y === this.breakPoints[4].y){
                        console.log(5);
                          el.x = el.x +this.oneBox/2;
                          this.ctx_2.fillRect(el.x,el.y,el.width,el.height);
                    } else if(el.y <= this.breakPoints[5].y+this.oneBox){
